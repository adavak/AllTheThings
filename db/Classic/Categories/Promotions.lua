...
h(-520,{
p(107,{awp=11101,b=1,itemID=20371,petTypeID=1,q=1,spellID=24696,u=2})}),
h(-521,{u=3,g={
...
q(5841,{maps={1426},providers={{"i",14647}},races={3,7},rwp=20001,u=3}),
q(5805,{maps={1429},providers={{"i",14646}},races={1},rwp=20001,u=3}),
q(5842,{maps={1438},providers={{"i",14648}},races={4},rwp=20001,u=3}),
q(5843,{maps={1411},providers={{"i",14649}},races={2,8},rwp=20001,u=3}),
q(5844,{maps={1412},providers={{"i",14650}},races={6},rwp=20001,u=3}),
q(5847,{maps={1420},providers={{"i",14651}},races={5},rwp=20001,u=3})}}),
h(-47,{description="Every character you created was able to select between one of the three pets by completing the 'Welcome!' quest for your race.",rwp=20001,sourceQuests={5805,5841,5842,5843,5844,5847},u=3,g={
...
p(1073,{awp=11201,b=1,itemID=22780,petTypeID=1,q=1,spellID=28487,u=2})}}),
h(-547,{
...
flt(101,{awp=20001,u=1,g={
p(130,{awp=20001,b=1,itemID=23713,petTypeID=3,q=1,spellID=30156,u=1})}}),
flt(50,{awp=20001,u=1}),
flt(100,{awp=20001,u=1,g={
mnt(30174,{awp=20001,b=1,itemID=23720,lvl=20,q=1,races={1,2,3,4,5,6,7,8},u=1})}}),
flt(9,{awp=20001,u=1,g={
s(165302,23705,{awp=20001,b=1,f=9,q=4,u=1}),
s(165303,23709,{awp=20001,b=1,f=9,q=1,u=1})}}),
flt(102,{awp=20001,u=1,g={
