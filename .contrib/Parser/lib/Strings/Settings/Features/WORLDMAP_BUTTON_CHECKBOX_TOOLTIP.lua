createLocalizationString({
	...
	text = {
		...
		-- TODO: ko = "",
		cn = "如果要在世界地图上看到 ATT 按钮，请启用此选项。使用此按钮可以快速访问当前显示区域的小列表。通常情况下，你需要亲自前往该区域才能看到小列表上的内容，你可以通过在聊天框中键入'/att mini'来访问小列表。",
		tw = "如果要在世界地圖上看到 ATT 按鈕，請啟用此選項。使用此按鈕可以快速拜訪當前顯示區域的小列表。通常情況下，你需要親自前往該區域才能看到小列表上的內容，你可以通過在聊天框中鍵入'/att mini'來拜訪小列表。",
	},
})
