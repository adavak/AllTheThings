createLocalizationString({
	...
	text = {
		...
		-- TODO: it = "",
		-- TODO: pt = "",
		ru = "Включите эту опцию, чтобы разрешить интеграцию подсказок для клеток питомцев. (Это отображается в дополнительной подсказке TSM или в подсказке сравнения предметов, когда включено.)",
		-- TODO: ko = "",
