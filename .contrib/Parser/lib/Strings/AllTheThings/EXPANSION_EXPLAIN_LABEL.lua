createLocalizationString({
	readable = "Select which expansions' content you want to see in your collection windows.",
	constant = "EXPANSION_EXPLAIN_LABEL",
	export = true,
	text = {
		en = "Select which expansions' content you want to see in your collection windows.",
		es = "Selecciona qué contenido de expansiones quieres ver en tus ventanas de colección.",
		de = "Wähle aus, welche Erweiterungsinhalte du in deinen Sammlungsfenstern sehen möchtest.",
