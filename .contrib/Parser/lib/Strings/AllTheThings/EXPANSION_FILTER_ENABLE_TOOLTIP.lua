createLocalizationString({
	...
	text = {
		...
		it = "Abilita o disabilita la funzione di filtraggio del contenuto per espansione.\n\n|cffff0000Attenzione:|r Le informazioni sulla timeline nei database attuali di WoD/Legion/BfA sono incomplete e potenzialmente molto imprecise. Usare con cautela.",
		pt = "Ativar ou desativar o recurso de filtragem de conteúdo por expansão.\n\n|cffff0000Aviso:|r As informações da linha do tempo nos bancos de dados atuais de WoD/Legion/BfA estão incompletas e potencialmente muito imprecisas. Use com cautela.",
		ru = "Включить или отключить функцию фильтрации контента по дополнениям.\n\n|cffff0000Внимание:|r Информация о временной шкале в текущих базах данных WoD/Legion/BfA неполная и потенциально крайне неточная. Используйте с осторожностью.",
		ko = "확장팩 콘텐츠 필터링 기능을 활성화하거나 비활성화합니다.\n\n|cffff0000경고:|r 현재 WoD/Legion/BfA 데이터베이스의 타임라인 정보는 불완전하고 매우 부정확할 수 있습니다. 주의해서 사용하세요.",
		cn = "启用或禁用资料片内容过滤功能。\n\n|cffff0000警告：|r当前WoD/Legion/BfA数据库中的时间线信息不完整，可能非常不准确。请谨慎使用。",
		tw = "啟用或停用資料片內容過濾功能。\n\n|cffff0000警告：|r目前WoD/Legion/BfA資料庫中的時間線資訊不完整，可能非常不準確。請謹慎使用。",
	},
})
