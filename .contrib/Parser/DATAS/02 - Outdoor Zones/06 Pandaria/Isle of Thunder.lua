			...
			["groups"] = {
				n(ACHIEVEMENTS, {
					...
					ach(8111, { -- This Isn't Even My Final Form
						["description"] =
						"Kill Drakkari God-Hulk patrolling on foot path near coord, then drink a Zandalari Potion nearby.",
						...
						["groups"] = {
							m(518, {   -- Thunder King's Citadel
								...
								i(95497, { -- Burial Trove Key
									["description"] =
									"Used to open the Lei Shen's Burial Troves at the rest area after completing the scenario. These chests have a chance to contain  Tome of Otherworldly Venoms, which unlocks the hidden appearance!",
									["groups"] = {
								...
								i(95491, { -- Tattered Historical Parchments
									["description"] =
									"These parchments are inside chests in the solo scenario, which is accessible after getting a Key to the Palace of Lei Shen.",
								}),
							}),
						},
					}),
				...
				n(RARES, {
					...
					n(COMMON_BOSS_DROPS, sharedData({
						...
						i(94221, { -- Shan'ze Ritual Stone
							["description"] =
							"You will need 3 stones to summon special rares at their specific spawn points.",
						}),
					...
					n(70530, { -- Ra'sha <Tender of Sacrifices>
						...
						["groups"] = {
							...
							i(94158, {                 -- Big Bag of Zandalari Supplies
								["description"] =
								"Can contain all sorts of crafting reagents, gems, and BOE epics normally found on rares in Pandaria.",
