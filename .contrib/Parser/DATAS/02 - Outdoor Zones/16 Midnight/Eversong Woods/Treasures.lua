	...
	m(EVERSONG_WOODS_MID, {
		n(TREASURES, {
			...
			o(613697, {	-- Gift of the Phoenix
				["coord"] = { 41.0, 19.5, EVERSONG_WOODS_MID },
				["questID"] = 93544,
				["groups"] = {
			...
			o(617534, {	-- Gilded Arnillary Sphere
				["coord"] = { 44.6, 45.6, EVERSONG_WOODS_MID },
				["questID"] = 94740,
				["groups"] = {
			...
			o(613850, {	-- Hawkstrider Husbandry: Unabridged Edition
				["coord"] = { 57.8, 50.9, EVERSONG_WOODS_MID },
				["questID"] = 93562,
			}),
			o(526903, {	-- Memorial Plaque
				["coord"] = { 48.0, 88.2, EVERSONG_WOODS_MID },
				["questID"] = 91841,
			}),
			o(613847, {	-- Mirveda's Notes
				["coord"] = { 50.5, 43.5, EVERSONG_WOODS_MID },
				["questID"] = 93564,
			}),
			o(507966, {	-- Profane Research
				["coord"] = { 36.0, 72.5, EVERSONG_WOODS_MID },
				["questID"] = 93565,
			}),
			o(613861, {	-- Shrine of Dath'Remar
				["coord"] = { 37.6, 13.8, EVERSONG_WOODS_MID },
				["questID"] = 93563,
			}),
			...
			o(619650, {	-- Vista Point Flag
				["coord"] = { 50.3, 84.2, EVERSONG_WOODS_MID },
				["questID"] = 94540,
			}),
			o(619649, {	-- Vista Point Flag
				["coord"] = { 79.3, 60.8, EVERSONG_WOODS_MID },
				["questID"] = 94539,
			}),
			o(619621, {	-- Vista Point Flag
				["coord"] = { 20.2, 79.6, EVERSONG_WOODS_MID },
				["questID"] = 94536,
			}),
			o(619647, {	-- Vista Point Flag
				["coord"] = { 40.4, 10.1, EVERSONG_WOODS_MID },
				["questID"] = 94537,
			}),
		}),
	}),
