		...
		n(138706, bubbleDownSelf({	-- Mission Command Table
			...
			["groups"] = {
				ach(12869, {	-- Azeroth at War: After Lordaron
					["_doautomation"] = true,
					["groups"] = { i(245467, {["timeline"] = { ADDED_12_0_0 }}),},	-- Lordaeron Banded Crate (DECOR!)
				}),
				ach(12870, {	-- Azeroth at War: Kalimdor on Fire
					["_doautomation"] = true,
					["groups"] = { i(245483, {["timeline"] = { ADDED_12_0_0 }}),},	-- Lordaeron Spiked Weapon Rack (DECOR!)
				}),
				ach(12867, {	-- Azeroth at War: The Barrens
					["_doautomation"] = true,
					["groups"] = { i(245463, {["timeline"] = { ADDED_12_0_0 }}),},	-- Lordaeron Banded Barrel (DECOR!)
				}),
