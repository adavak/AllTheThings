		...
		n(TREASURES, {
			...
			header(HEADERS.Achievement, 61052, {	-- Dust 'Em Off
				...
				o(571127, {	-- Glowing Moth
					["coord"] = { 31.9, 81.8, MAP.MIDNIGHT.HARANDAR },
					["questID"] = 92203,
				}),
				...
				o(571130, {	-- Glowing Moth
					["coord"] = { 48.6, 55.3, MAP.MIDNIGHT.HARANDAR },
					["questID"] = 92307,
				}),
				...
				o(571158, {	-- Glowing Moth
					["coord"] = { 55.1, 32.8, MAP.MIDNIGHT.HARANDAR },
					["questID"] = 92227,
				}),
				...
				o(571153, {	-- Glowing Moth
					["coord"] = { 50.4, 33.6, MAP.MIDNIGHT.HARANDAR },
					["questID"] = 92232,
				}),
