	...
	n(INFINITE_BAZAAR, {
		...
		["groups"] = {
			...
			n(251042, { -- Domelius <Home Improvements>
				["description"] =
				"You can buy additional copies of Housing Decor after receiving the first one from the respective Achievement.",
			...
			n(241179, { -- Nostwin <Snacks and Stuff>
				...
				["groups"] = sharedData({
					...
					i(254320, { -- Elixir of Remembered Sight
						["description"] =
						"|cFFE50D12NOT CONSUMED ON USE:|r If you, by any chance, destroyed the one you received from the quest, buy only 1.",
					}),
				...
				["groups"] = bubbleDownFiltered({
					...
					filter(CONSUMABLES, {
						i(254849, { -- Minor Bronze Cache
							["description"] =
							"Becomes available after purchasing 'Hammer of Vigilance'.\n\nContains 2500 Bronze.",
							["cost"] = { { "i", 253305, 5 } }, -- 5x Felwarped Slab
						}),
						i(254850, {       -- Minor Bronze Cache
							["description"] =
							"Becomes available after purchasing 'The First Satyr's Spaulders'.\n\nContains 2500 Bronze.",
