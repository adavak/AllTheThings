...
root(ROOTS.WorldEvents, applyevent(EVENTS.REMIX_LEGION, n(REMIX_LEGION, {
	n(REWARDS, {
		...
		-- Following tokens start dropping at LVL80 and will rotate based on the Phase. Combining 10 of these has a chance to give you a new (appearance source) 'Legion Remix' variant of the item belonging to the Final Raid of the Phase.
		-- Sorting is a speculation based on a fact that I obtained Remix variant of [Otherworldy Leather Mantle] that drops from Il'gynoth, [Evergreen Vinewrap Drape] that drops from Cenarius, [Mask of Multitudinous Eyes] that drops from Elerethe Renferal.
		-- Following the "Same name of the item that drops from this boss" I extrapolated these. P3 and P4 may be incomplete. -- Exo
		i(253222, {	-- Corrupted Thorn of the Dream (Phase 1: The Emerald Nightmare)
			filter(CLOAKS, {
		...
		i(252364, {	-- Gem of Gul'dan (Phase 2: The Nighthold)
			filter(CLOAKS, {
		...
		i(253223, {	-- Fractal Felshard (Phase 3: Tomb of Sargeras)
			filter(CLOAKS, {
		...
		i(253224, {	-- Mote of the Unmaker's Heart (Phase 4: Antorus: the Burning Throne)
			filter(CLOAKS, {
		...
		i(253227, {	-- Flawless Thread of Time (Phase 5)
			...
			-- Exo Note: Maybe something new? Or Symlink to other(s)?
		}),
